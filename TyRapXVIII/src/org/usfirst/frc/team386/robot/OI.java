...
public class OI {
    ...
    public Button arcadeDriveVaultButton = new JoystickButton(xboxControl, RobotMap.moveToVaultLevelButton);
    public Button arcadeDriveLockElevator = new JoystickButton(xboxControl, RobotMap.chainBreakButton);
